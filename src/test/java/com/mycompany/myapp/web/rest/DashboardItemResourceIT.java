...
class DashboardItemResourceIT {
    ...
    void putNewDashboardItem() throws Exception {
        ...
        updatedDashboardItem.cols(UPDATED_COLS).rows(UPDATED_ROWS).x(UPDATED_X).y(UPDATED_Y).content(UPDATED_CONTENT);
    ...
    void partialUpdateDashboardItemWithPatch() throws Exception {
        ...
        partialUpdatedDashboardItem.y(UPDATED_Y);
    ...
    void fullUpdateDashboardItemWithPatch() throws Exception {
        ...
        partialUpdatedDashboardItem.cols(UPDATED_COLS).rows(UPDATED_ROWS).x(UPDATED_X).y(UPDATED_Y).content(UPDATED_CONTENT);
