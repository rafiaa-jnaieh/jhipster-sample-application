...
public class UserProfileDTO implements Serializable {
    ...
    private DashboardItemDTO dashboardItem;
    ...
    public DashboardItemDTO getDashboardItem() {
        return dashboardItem;
    }

    public void setDashboardItem(DashboardItemDTO dashboardItem) {
    ...
    public String toString() {
        return "UserProfileDTO{" +
            ...
            ", dashboardItem=" + getDashboardItem() +
            "}";
    }
}
