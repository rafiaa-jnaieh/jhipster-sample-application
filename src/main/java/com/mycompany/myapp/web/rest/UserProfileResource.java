...
public class UserProfileResource {
    ...
    public ResponseEntity<UserProfileDTO> updateUserProfile(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, userProfileDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<UserProfileDTO> partialUpdateUserProfile(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, userProfileDTO.getId())
        );
    }
