...
public class DashboardItem implements Serializable {
    ...
    @DBRef
    @Field("userProfile")
    @JsonIgnoreProperties(value = { "dashboardLayout", "dashboardItem" }, allowSetters = true)
    ...
    public void setUserProfiles(Set<UserProfile> userProfiles) {
        if (this.userProfiles != null) {
            this.userProfiles.forEach(i -> i.setDashboardItem(null));
        }
        if (userProfiles != null) {
            userProfiles.forEach(i -> i.setDashboardItem(this));
        }
        this.userProfiles = userProfiles;
    }

    public DashboardItem userProfiles(Set<UserProfile> userProfiles) {
        this.setUserProfiles(userProfiles);
        return this;
    }

    public DashboardItem addUserProfile(UserProfile userProfile) {
        this.userProfiles.add(userProfile);
        userProfile.setDashboardItem(this);
        return this;
    }

    public DashboardItem removeUserProfile(UserProfile userProfile) {
        this.userProfiles.remove(userProfile);
        userProfile.setDashboardItem(null);
        return this;
    }
