...
describe('DashboardItem routing resolve service', () => {
  ...
  let resultDashboardItem: IDashboardItem | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IDashboardItem if id is not provided', () => {
      // GIVEN
      ...
      expect(resultDashboardItem).toEqual(new DashboardItem());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as DashboardItem })));
      mockActivatedRouteSnapshot.params = { id: 'ABC' };
